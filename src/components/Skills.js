          ...
          <div className="col-12">
            <div className="skill-bx wow zoomIn">
              ...
              <Carousel responsive={responsive} infinite={true} className="owl-carousel owl-theme skill-slider">
                <div className="item">
                  <img src={meter1} alt="Attention to Detail Icon" />
                  <h5>Attention to Detail</h5>
                </div>
                <div className="item">
                  <img src={meter2} alt="Collaboration Icon" />
                  <h5>Collaboration and Communication</h5>
                </div>
                <div className="item">
                  <img src={meter3} alt="Flexibility Icon" />
                  <h5>Flexibility</h5>
                </div>
                <div className="item">
                  <img src={meter1} alt="Versatility Icon" />
                  <h5>Versatility</h5>
                </div>
              </Carousel>
            </div>
